...
export default function Dashboard() {
  ...
  const avatar_url = user?.imagem //? "https://voxnews.com.br/wp-content/uploads/2017/04/unnamed.png" : user?.imagem
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 p-6 bg-gray-100">
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-4 rounded-md shadow-md">
              <h3 className="text-lg font-semibold text-gray-700 mb-4">Reports</h3>
              <p className="text-gray-600">Content goes here...</p>
            </div>
          </div>
        </main>
